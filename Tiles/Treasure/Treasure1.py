...
class Treasure1(Treasure):
    ...
    def __init__(self):
        super(Treasure1, self).__init__()
        self.quantity_coin = Treasure1.quantity_coin
        self.sign_paint_tile = Treasure1.sign_level

    def activate_tile(self, player, unit):
        super(Treasure1, self).activate_tile(player, unit)
