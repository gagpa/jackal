...
class Treasure3(Treasure):
    ...
    def __init__(self):
        super(Treasure3, self).__init__()
        self.quantity_coin = Treasure3.quantity_coin
        self.sign_paint_tile = Treasure3.sign_level

    def activate_tile(self, player, unit):
        super(Treasure3, self).activate_tile(player, unit)
